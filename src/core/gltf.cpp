...
#include "render/vulkan/graphics.h"
...
namespace gltf
{
    bool loadModel(Scene &model, vulkan::Graphics &graphics, std::filesystem::path modelFile)
    {
    ...
    void loadGltfNode(Scene &model, SceneNode &node, cgltf_data *data, cgltf_node *gltfNode)
    {
    ...
    void loadGltfTextures(Scene &model, vulkan::Graphics &graphics, std::filesystem::path dir, cgltf_data *data)
    {
