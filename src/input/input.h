...
private:
    ...
    UnorderedMap<SDL_Keycode, bool> previousKeys;
    UnorderedMap<SDL_Keycode, bool> currentKeys;

    UnorderedMap<SDL_MouseButtonFlags, bool> previousMouseButtons;
    UnorderedMap<SDL_MouseButtonFlags, bool> currentMouseButtons;
